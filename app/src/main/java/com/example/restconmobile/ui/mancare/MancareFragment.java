package com.example.restconmobile.ui.mancare;
...
public class MancareFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        for (String x : ComandaMenu.produseDataBase)
            if (x.split(",")[3].contains("mancare") && !x.split(",")[4].equals("0"))
                produse.add(x.split(",")[5]);
        ListView listView = (ListView) view.findViewById(R.id.mancareList);
